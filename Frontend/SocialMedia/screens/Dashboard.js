...
const DashboardApp = () => {
    ...
    const handleProfilePress = () => {
        navigation.navigate('Profile'); // Naviguer vers 'ProfileScreen'
    };
    const renderSection = () => {
    ...
    const HomeSection = () => (
        <View style={styles.container}>
            ...
            <View style={styles.featuresContainer}>
                <PressableFeatureBox name="Analyse"
                ...
                <PressableFeatureBox name="Taches"
                    icon="checkbox-outline" onPress=
                    {
                        () => setActiveSection('Tache')
                    } />
                <PressableFeatureBox name="Historique"

      ...
      <ScrollView contentContainerStyle={styles.scrollView}>
        ...
        {publications.map((publication, index) => (
          <Publication
            ...
            content={publication.imageSource || publication.fileSource} // Utilisation de la propriété content pour la vidéo ou l'image
            contentType={publication.imageSource ? 'image' : 'video'} // Ajout de la vérification pour le type de contenu
        ...
        <TouchableOpacity style={styles.selectFileButton} onPress={handleSelectNewVideo}>
          <Ionicons name="videocam-outline" size={24} color="black" />
          <Text style={styles.selectFileButtonText}>Vidéos</Text>
        </TouchableOpacity>
        <TextInput
